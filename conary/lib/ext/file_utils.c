/* Generated by Cython 0.20.2 on Wed Aug 27 18:48:28 2014 */
 ...
 *     count = 0
 */
    __pyx_t_6 = PyErr_SetFromErrno(__pyx_builtin_OSError); if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 69; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 * 
 */
    __pyx_t_5 = (((__pyx_v_ufds[__pyx_v_i]).revents != POLLNVAL) != 0);
    if (__pyx_t_5) {
 ...
 */
  ...
  __pyx_t_6 = __Pyx_PyInt_From_int(__pyx_v_count); if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 77; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_6);
  __pyx_r = __pyx_t_6;
  __pyx_t_6 = 0;
  goto __pyx_L0;
 ...
 */
    ...
    if (!__pyx_t_4) {
      __pyx_t_1 = ((__pyx_t_2 == ENAMETOOLONG) != 0);
      __pyx_t_3 = __pyx_t_1;
    } else {
      __pyx_t_3 = __pyx_t_4;
    }
    if (!__pyx_t_3) {
      __pyx_t_4 = ((__pyx_t_2 == EACCES) != 0);
      __pyx_t_1 = __pyx_t_4;
    } else {
      __pyx_t_1 = __pyx_t_3;
    }
 ...
 * 
 */
    __pyx_t_5 = PyErr_SetFromErrnoWithFilename(__pyx_builtin_OSError, __pyx_v_path); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 109; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 *     rc = 0
 */
    __pyx_t_2 = __Pyx_PyObject_Call(__pyx_builtin_ValueError, __pyx_tuple_, NULL); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 119; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_2);
 ...
 * 
 */
    __pyx_t_2 = PyErr_SetFromErrno(__pyx_builtin_OSError); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 148; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_2);
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
    goto __pyx_L12;
  }
 ...
 *     return True
 */
    __pyx_t_5 = PyErr_SetFromErrnoWithFilename(__pyx_builtin_OSError, __pyx_v_path); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 189; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_5);
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
    goto __pyx_L3;
  }
...
static struct PyModuleDef __pyx_moduledef = {
    ...
    __Pyx_DOCSTR(__pyx_k_Collection_of_wrappers_around_f), /* m_doc */
    -1, /* m_size */
...
#endif
{
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4(__Pyx_NAMESTR("file_utils"), __pyx_methods, __Pyx_DOCSTR(__pyx_k_Collection_of_wrappers_around_f), 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
...
static CYTHON_INLINE off_t __Pyx_PyInt_As_off_t(PyObject *x) {
    ...
    if (likely(PyInt_Check(x))) {
        if (sizeof(off_t) < sizeof(long)) {
            __PYX_VERIFY_RETURN_INT(off_t, long, PyInt_AS_LONG)
        } else {
            long val = PyInt_AS_LONG(x);
            if (is_unsigned && unlikely(val < 0)) {
                PyErr_SetString(PyExc_OverflowError,
    ...
    if (likely(PyLong_Check(x))) {
        if (is_unsigned) {
#if CYTHON_COMPILING_IN_CPYTHON && PY_MAJOR_VERSION >= 3
 #if CYTHON_USE_PYLONG_INTERNALS
            if (sizeof(digit) <= sizeof(off_t)) {
                switch (Py_SIZE(x)) {
                    case  0: return 0;
                    case  1: return (off_t) ((PyLongObject*)x)->ob_digit[0];
                }
            }
 #endif
#endif
            ...
            if (sizeof(off_t) <= sizeof(unsigned long)) {
                __PYX_VERIFY_RETURN_INT(off_t, unsigned long, PyLong_AsUnsignedLong)
            } else if (sizeof(off_t) <= sizeof(unsigned long long)) {
                __PYX_VERIFY_RETURN_INT(off_t, unsigned long long, PyLong_AsUnsignedLongLong)
            }
        } else {
#if CYTHON_COMPILING_IN_CPYTHON && PY_MAJOR_VERSION >= 3
 #if CYTHON_USE_PYLONG_INTERNALS
...
#endif
            if (sizeof(off_t) <= sizeof(long)) {
                __PYX_VERIFY_RETURN_INT(off_t, long, PyLong_AsLong)
            } else if (sizeof(off_t) <= sizeof(long long)) {
                __PYX_VERIFY_RETURN_INT(off_t, long long, PyLong_AsLongLong)
            }
        }
        {
#if CYTHON_COMPILING_IN_PYPY && !defined(_PyLong_AsByteArray)
