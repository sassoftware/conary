    ...
    <body py:match="item.tag == '{http://www.w3.org/1999/xhtml}body'">
        ...
        <div id="main">
            ...
            <ul class="menu">
                ...
                <li py:if="isAdmin" py:attrs="{'class': (lastchunk in ('userlist', 'addUserForm', 'addPermForm', 'editPermForm', 'manageGroupForm',)) and 'highlighted' or None}"><a href="userlist">Users and Roles</a></li>
